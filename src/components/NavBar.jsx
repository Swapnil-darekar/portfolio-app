...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-4 text-white fixed" style={{backgroundColor: '#2B3856', boxShadow: '5px 5px 10px #000000'}}>
      <div>
        <h1 className="text-5xl font-signature ml-2" style={{color: '#91EDED'}}>Swapnil</h1>
      </div>
...
//       <div>
//         <h1 className='text-5xl font-signature'> Swapnil </h1>
//       </div>
//       <ul className='hidden md:flex'>
//         {links.map(({id, link}) => (
//           <li
